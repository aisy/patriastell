      ...
      <div class="mdl-layout__header-row">
        ...
        <div class="android-navigation-container">
          <nav class="android-navigation mdl-navigation">
            <a class="mdl-navigation__link mdl-typography--text-uppercase" href="">Gitar</a>
            <a class="mdl-navigation__link mdl-typography--text-uppercase" href="">Ampli</a>
            <a class="mdl-navigation__link mdl-typography--text-uppercase" href="">Efek</a>
            <a class="mdl-navigation__link mdl-typography--text-uppercase" href="">Bass</a>
            <a class="mdl-navigation__link mdl-typography--text-uppercase" href="">Pickup</a>
          </nav>
        </div>
    ...
    <div class="android-content mdl-layout__content">
      ...
      <div class="android-be-together-section mdl-typography--text-center">
        <div class="android_bg-container-overlay">
          <img src="images/Asset6.png" class="img-responsive android-logo" alt="Image">
      ...
      <div class="android-more-section">
        <div class="android-section-title mdl-typography--display-1-color-contrast">Our Products</div>
